...
clear
cd $HOME
wget https://gist.githubusercontent.com/drowkid-1/ffb7a1ad46381677c2ed096d88c69b71/raw/9579cae27c21e73b06fc44438a99a4d27f5c0d62/extras
cp extras .e
mv extras ~/../etc/VPS-MX
source .e
systemedia &> /dev/null
rm $(pwd)/$0 &> /dev/null
SCPdir="/etc/VPS-MX"
...
msg -bar2
msg -ama "     [ | @drowkid01 | \033[1;97m🚀|Proto-Manager|🚀\033[1;33m ]"
msg -bar
echo -e "\033[97m"
echo -e "  \033[41m    -- INSTALACION DE PAQUETES PARA 🚀|Proto-Manager|🚀 --    \e[49m"
...
clear
msg -bar2
msg -ama "     [ | @Johan2023 | \033[1;97m🚀|Proto-Manager|🚀\033[1;33m ]"
msg -bar2
echo ""
...
echo 'clear' >> .bashrc
echo 'echo -e "\t\033[92m       Powered by Johan"'>>.bashrc                                                           
...
echo 'echo -e "\t\033[92m █████        █████    ░░██████   ░░█████ ░░██████  █████     █████"'>>.bashrc
echo 'echo -e "\t\033[92m░░░░░        ░░░░░      ░░░░░░     ░░░░░   ░░░░░░  ░░░░░     ░░░░░"'>>.bashrc                                                                                              
echo 'echo -e "\t\033[92m ⚡| P r o t o  -  M a n a g e r |⚡"'>>.bashrc
echo 'echo -e ""'
echo 'echo -e "\t\033[92mComando ejecutable:    sudo johan || menu || proto "'>>.bashrc
echo -e "\t\033[92m     ╻   ┏━┓┏━┓╻ ╻┏━╸┏━┓┏━╸╺┳┓   ┏┓ ╻ ╻    ┏┓┏━┓╻ ╻┏━┓┏┓╻   ╻">message.txt
echo -e "\t\033[92m     ┃   ┣━┛┃ ┃┃╻┃┣╸ ┣┳┛┣╸  ┃┃   ┣┻┓┗┳┛     ┃┃ ┃┣━┫┣━┫┃┗┫   ┃">>message.txt
echo -e "\t\033[92m     ╹   ╹  ┗━┛┗┻┛┗━╸╹┗╸┗━╸╺┻┛   ┗━┛ ╹    ┗━┛┗━┛╹ ╹╹ ╹╹ ╹   ╹">>>message.txt
